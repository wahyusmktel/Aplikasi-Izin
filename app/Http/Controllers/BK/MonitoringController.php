...
class MonitoringController extends Controller
{
    ...
    {
        // Logika ini sama dengan Monitoring Kesiswaan
        try {
            ...
            return view('pages.bk.monitoring.index', compact('perizinan', 'kelas'));

        } catch (\Exception $e) {
            Log::error('Error fetching all permissions for BK: ' . $e->getMessage());
