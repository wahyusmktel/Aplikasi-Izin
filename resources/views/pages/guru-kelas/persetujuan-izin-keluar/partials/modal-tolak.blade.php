<x-modal :name="'tolak-izin-' . $izin->id" focusable>
    <form method="post" action="{{ route('guru-kelas.persetujuan-izin-keluar.reject', $izin->id) }}" class="p-6">
        @csrf
        @method('patch')
        ...
        <div class="mt-6">
            ...
            <textarea id="alasan_penolakan_{{ $izin->id }}" name="alasan_penolakan"
