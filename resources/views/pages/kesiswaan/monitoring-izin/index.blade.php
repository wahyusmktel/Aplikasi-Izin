        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('kesiswaan.monitoring-izin.index') }}" method="GET" class="mb-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tgl Izin
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Status
                                    </th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Diproses
                                        Oleh</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($perizinan as $izin)
                                    <tr x-data="{ item: {{ json_encode($izin) }} }">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{ \Carbon\Carbon::parse($izin->tanggal_izin)->isoFormat('D MMM YY') }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @php
                                                $statusClass = [
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            {{ $izin->approver->name ?? 'Belum diproses' }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 text-center">Tidak ada data untuk
                                            ditampilkan.</td>
                                    </tr>
                                @endforelse
                            </tbody>
