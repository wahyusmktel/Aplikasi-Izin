                    ...
                    @role('Koordinator Prakerin|Waka Kesiswaan|Kurikulum')
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('prakerin.industri.index')" :active="request()->routeIs('prakerin.industri.*')">
                                        {{ __('Data Industri') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('prakerin.penempatan.index')" :active="request()->routeIs('prakerin.penempatan.*')">
                                        {{ __('Penempatan Siswa') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
